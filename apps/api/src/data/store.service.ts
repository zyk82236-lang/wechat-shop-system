...
export class StoreService {
  ...
  private seed(): void {
    ...
    this.categories.push(
      { id: "cat_food", name: "休闲零食", sort: 1, enabled: true },
      { id: "cat_drink", name: "饮品冲调", sort: 2, enabled: true },
    );
    ...
    this.adminUsers.push(
      { id: "admin_root", username: "admin", password: "admin123", role: "SUPER_ADMIN" },
      { id: "admin_ops", username: "ops", password: "ops123", role: "OPERATOR" },
    );
  }
}
